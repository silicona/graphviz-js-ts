...
$(function () {
    ...
    document.querySelectorAll('svg[data-src]').forEach(function (svg) {
        //console.log(svg);
        /* Cargamos el contenido en su HTML interno */
        fetch(svg.dataset.src)
            .then(function (respuesta) { return __awaiter(_this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = console).log;
                        return [4 /*yield*/, respuesta.text()];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [4 /*yield*/, respuesta.text()];
            ...
            .then(function (xml) { return svg.innerHTML = xml; });
    });
});
/*
